...
SECRET_KEY = 'django-insecure-j8#&0%tl4btm=pv5qo4flfhyl7a05(30ll8t7l^1bu=o0l-p31'
...
ROOT_URLCONF = 'factcheak_nb.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'post.context.related', 
            ],

            'libraries': {
                'markdown_extras': 'post.templatetags.markdown_extras' 
            }
        },
    },
]

WSGI_APPLICATION = 'factcheak_nb.wsgi.application'
